...
1. **결론 + 핵심 시그널** — 결론 문장 1개 + 핵심 시그널 1~2개를 대시(—)·콤마로 연결
   ...
   - 좋은 예: "이번 주 안에 결정 — 박원국 시간당 20만원 확정 + 고객 '금주 회신' 약속. AI Agent + 중간관리자 두 과정 동시 성사 가능성"
...
5. **티어별 톤:**
   ...
   **T1 reason (집중)** — "왜 지금 즉시 대응해야 하는가":
   ...
   - 예: "4/22~4/27 양방향 메일·슬랙 활발, 4/27 박원국 시간당 20만원 확정 견적서 진행. 고객 '금주 중 의사결정 후 회신' 약속 + 능동 요구사항 추가. AI Agent + 중간관리자 두 과정 동시 진행 흐름 — 이번 주 내 결정 시 양쪽 성사 가능성 높음."
